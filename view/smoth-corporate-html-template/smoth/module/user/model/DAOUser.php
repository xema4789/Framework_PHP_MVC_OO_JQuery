...
//poner lo del path
	...
	class DAOUser{
		function insert_user($datos){
        	...
        	//     $hobby=$hobby."$indice:";
        	// }
        	$sql = " INSERT INTO Habitaciones (`Tipo_habitacion`, `Numero_habitacion`, `Tipo_comida`, `email`, `Contrasenya`, `Fecha_entrada`, `Fecha_salida`,`Piscina`,`Mayordomo`)"
        		. " VALUES ('$tipo_habitacion', '$num_habitacion', '$tipo_comida', '$email', '$pass', '$f_ini', '$f_fin','$piscina','$mayordomo')";
		...
		function update_user($datos){
        	...
        	$sql = " UPDATE Habitaciones SET Tipo_habitacion='$tipo_habitacion', Tipo_comida='$tipo_comida', email='$email', Contrasenya='$pass', Fecha_entrada='$f_ini',"
        		. " Fecha_salida='$f_fin' WHERE Numero_habitacion='$num_habitacion'";
