            ...
            <tbody>
                <?php
                    if ($rdo->num_rows === 0){
                        ...
                        //echo '<td whidth=125'.'"<a class="Button_green" href="index.php?page=controller_user&op=update&id='.$row['Numero_habitacion'].'">Update</a>'.'</td>';
                            //echo '<td whidth=125'.'<a id="update" href="index.php?page=controller_user&op=update&id='.$row['Numero_habitacion'].'">Update</a>'.'</td>'; 
                        //echo '<td whidth=125'.'<a class="Button_red" href="index.php?page=controller_user&op=delete&id='.$row['Numero_habitacion'].'">Delete</a>'   .'</td>';
                    	   	//echo '<td width=350>';
                    	   	// echo '<a class="Button_blue" href="index.php?page=controller_user&op=read&id='.$row['Numero_habitacion'].'">Read</a>';
                            // echo '&nbsp;';
                                                //\"habitacion\"
                            // echo ("<div class='habitacion' id='".$row['Numero_habitacion']."'>Read</div>");  //READ el css no me coge el class , creo que por las comillas simples
                    	    //echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';

                    	   	//echo '<a class="Button_green" href="index.php?page=controller_user&op=update&id='.$row['Numero_habitacion'].'">Update</a>';
                    	   	// echo '&nbsp;';
                    	   	// echo '<a class="Button_red" href="index.php?page=controller_user&op=delete&id='.$row['Numero_habitacion'].'">Delete</a>';
                    	   	echo '</td>';
                    	   	echo '</tr>';
                        }
                    }
